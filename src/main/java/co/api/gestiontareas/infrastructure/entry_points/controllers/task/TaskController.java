package co.api.gestiontareas.infrastructure.entry_points.controllers.task;
...
import co.api.gestiontareas.infrastructure.entry_points.controllers.task.request.CreateTaskRequest;
import co.api.gestiontareas.infrastructure.entry_points.controllers.task.request.UpdateTaskRequest;
...
public class TaskController {
    ...
    @Operation(summary = "Crear tarea", description = "", security = {
    ...
    @Operation(summary = "Eliminar tarea por ID", description = "", security = {
            @SecurityRequirement(name = "BearerAuth")    }, tags={ "Task" })
    @ApiResponses(value = {
    ...
    @Operation(summary = "Obtener tarea por ID", description = "", security = {
            @SecurityRequirement(name = "BearerAuth")    }, tags={ "Task" })
    @ApiResponses(value = {
    ...
    @Operation(summary = "Actualizar tarea existente", description = "", security = {
            @SecurityRequirement(name = "BearerAuth")    }, tags={ "Task" })
    @ApiResponses(value = {
